...
export const mockListings = [
  {
    ...
    description: 'Affordable accommodation for corps members with 24/7 electricity, water supply, and security. Located within walking distance of NYSC secretariat. Features include single rooms, shared apartments, and studio options with internet connectivity and laundry services. Regular transport service to major locations available.',
    rating: 4.5
  },
  {
    $id: 'list2',
  ...
  },
  {
    ...
    description: 'Social club focused on networking and recreational activities for young professionals and corps members. Weekly events including game nights, movie screenings, and talent showcases. Volunteering opportunities and community outreach programs. Affordable membership with complimentary welcome package.',
    rating: 4.5
  },
];
