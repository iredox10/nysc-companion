...
import { FaTimes, FaHome, FaUtensils, FaBus, FaMedkit, FaShoppingBag, FaFilm, FaBuilding, FaGraduationCap, FaCar, FaHammer, FaEdit } from 'react-icons/fa';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white/80">Update category information</p>
              </div>
            </div>
            <button
              onClick={onClose}
